...
\emph{``back up slowly''}, \emph{``rotate left''} --- and having the robot carry
it out. The language model runs \textbf{on the laptop}, so no text ever leaves
the machine.
...
{"action": "forward", "duration_s": 3, "speed": "normal"}
\end{lstlisting}
